...
public class Hero {
    ...
    /**
     * Creates a memento snapshot capturing the hero's current mutable state.
     *
     * @return a HeroMemento snapshot of name, hp, mana, gold, maxHp, attack,
     *         defense, and a copy of the current inventory list
     */
     ...
     *
     * @param memento the snapshot to restore from; ignored if null
     */
